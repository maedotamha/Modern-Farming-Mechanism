...
import { exportedValues } from "@/app/config/page";
...
export default function FarmWiseAIPage() {
  ...
  const locationSuggestions = {
    "Addis Ababa": "Addis Ababa has a mild climate. Frequent watering is essential during dry months.",
    ...
    "Bahir Dar": "Bahir Dar has a humid climate. Monitor pest activity in wetter months.",
    "Dire Dawa": "Dire Dawa is dry and hot. Choose crops that require minimal water.",
  ...
  useEffect(() => {
    ...
    if (window.location.pathname === "/ai-feed") {
      ...
      botpressScript2.src = "https://files.bpcontent.cloud/2024/12/26/11/20241226112806-0TQJK2YL.js";
    ...
    <div className="p-6 space-y-6">
      <div className="relative h-48 rounded-xl overflow-hidden mb-8">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-green-900/80 to-transparent flex items-center">
          <div className="p-8">
            <h1 className="text-3xl font-bold text-white mb-2">FarmWiseAI Insights</h1>
            <p className="text-green-50">Smart recommendations for optimal farming conditions</p>
          </div>
        </div>
      </div>
